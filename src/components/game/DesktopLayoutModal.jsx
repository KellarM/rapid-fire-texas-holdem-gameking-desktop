...
const LAYOUTS = [
  {
    ...
    description: '3-column: History | Center Board | Rank + Side Bets',
  },
  {
    id: '2',
    label: 'Layout 2 — Strips',
    description: 'Full-width strips: River → Color → Rank → Hands → Footer',
  },
];
    ...
    <>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '20px' }}>
          <Monitor size={20} style={{ color: '#facc15' }} />
        ...
        <p style={{ fontSize: '12px', color: '#94a3b8', marginBottom: '16px', lineHeight: 1.5 }}>
          Select the board arrangement for desktop view. Layout 1 is the current 3-column design. Layout 2 stacks each board as a full-width strip.
        </p>
