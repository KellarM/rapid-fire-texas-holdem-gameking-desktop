...
export default function SideBets({
  ...
  return (
    <div className="flex flex-col h-full gap-1">
      {/* Color Board */}
      <div className={`relative flex flex-col min-h-0 ${boardStateClass}`} style={{ flex: '3 1 0', border: '3px solid #e8b84b', borderRadius: '0.75rem', background: 'rgba(0,0,0,0.45)', boxShadow: '0 0 0 1px #000 inset, 0 0 8px rgba(232,184,75,0.3), 0 2px 8px rgba(0,0,0,0.6)' }}>
      ...
      {/* River — Low / High */}
      <div className={`relative flex flex-col min-h-0 ${boardStateClass}`} style={{ flex: '2 1 0', border: '3px solid #e8b84b', borderRadius: '0.75rem', background: 'rgba(0,0,0,0.45)', boxShadow: '0 0 0 1px #000 inset, 0 0 8px rgba(232,184,75,0.3), 0 2px 8px rgba(0,0,0,0.6)' }}>
        {/* Header row — label left, Match Cap pill right, same flex row */}
        {!compactLandscape && (
