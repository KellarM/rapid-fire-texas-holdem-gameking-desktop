...
export default function ToolsMenu({
  ...
  return (
    <div className="relative" ref={ref} style={{ visibility: toolsVisible ? 'visible' : 'hidden' }}>
      ...
      {promptOpen && (
        <div className="absolute left-0 top-full mt-1.5 w-64 bg-slate-900 border border-yellow-700/40 rounded-xl shadow-2xl shadow-black/60 z-50 p-3">
      ...
      {open && (
        <div className="absolute left-0 top-full mt-1.5 w-60 bg-slate-900 border border-yellow-700/40 rounded-xl shadow-2xl shadow-black/60 z-50 overflow-hidden">
